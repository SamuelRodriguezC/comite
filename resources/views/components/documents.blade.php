@php
    $documents = [
        [
            ...
            'icon' => 'academic-cap',
            'type' => 'fas',
            'link' => asset('/documents/Reglamento.pdf'),
        ],
        [
            ...
            'icon' => 'academic-cap',
            'type' => 'fas',
            'link' => asset('/documents/reglamento-grados-ingenieria-2022.pdf'),
        ],
        [
            'title' => 'Formato presentación Propuesta',
            'icon' => 'file-word',
            'type' => 'fas',
            'link' => asset('/documents/propuesta.docx'),
        ],
        [
            'title' => 'Guía Elaboracion Anteproyecto',
            'icon' => 'file-pdf',
            'type' => 'fas',
            'link' => asset('/documents/guia_anteproyecto.pdf'),
        ],
        [
            'title' => 'Guía Elaboración documento Final',
            'icon' => 'file-pdf',
            'type' => 'fas',
            'link' => asset('/documents/guia_documento.pdf'),
        ],
        [
            'title' => 'Rúbrica - Presentacion de Póster',
            'icon' => 'file-word',
            'type' => 'fas',
            'link' => asset('/documents/rubrica-poster.docx'),
        ],
    ];
@endphp
