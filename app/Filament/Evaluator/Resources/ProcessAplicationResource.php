...
use App\Filament\Evaluator\Resources\ProcessAplicationResource\Pages;
use App\Filament\Evaluator\Resources\ProcessAplicationResource\RelationManagers;
    ...
    public static function form(Form $form): Form
    {
        ...
        ->schema([
            ...
            Forms\Components\Toggle::make('completed')
                ...
                ->dehydrateStateUsing(
                    fn (bool $state) => $state ? 1 : 0
                )
                ->afterStateHydrated(
                    function (Forms\Components\Toggle $component, $state) {
