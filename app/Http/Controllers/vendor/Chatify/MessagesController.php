...
class MessagesController extends Controller
{
    ...
    public function fetch(Request $request)
    {
        ...
        if ($totalMessages < 1) {
            $response['messages'] ='<p class="message-hint center-el"><span>Escribe algo para comenzar a chatear</span></p>';
    ...
    public function sharedPhotos(Request $request)
    {
        ...
        // send the response
        return Response::json([
            'shared' => count($shared) > 0 ? $sharedPhotos : '<p class="message-hint"><span>Sin Compartidos</span></p>',
        ], 200);
    }
